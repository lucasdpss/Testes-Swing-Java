...
public class Tela1 extends JPanel{
	private static final long serialVersionUID = 1L; //acabar com uma warning (nao descobri pra que serve esse serial)
	...
	public void show() {
		JFrame frame = new JFrame("Fase 1");  //cria a janela com esse titulo da string indicada
	    frame.setSize(800, 600);  //tamanho da janela
	    frame.add(new Tela1());   //esse novo frame vai usar essa propria classe para criar a tela
